...
import 'package:coffee_and_code/other/helper.dart';
            ...
            child: ListView(children: <Widget>[
              Container(
                  ...
                  child: Text(
                    ...
                    style: GoogleFonts.bowlbyOneSc(
                        fontSize: 70, color: Colors.brown),
                  )),
              Container(
                  ...
                  child: Text(
                    ...
                    style: GoogleFonts.fredokaOne(
                        fontSize: 26, color: Colors.brown),
                  )),
              Container(
              ...
              Container(
                  ...
                  child: Text(
                    newAccValidate,
                    style:
                        GoogleFonts.fredokaOne(color: Colors.red, fontSize: 12),
                  )),
              Container(
                height: 90,
                padding: const EdgeInsets.all(20),
                child: ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      if (!RegExp(
                        ...
                        newAccValidate =
                            'Password not valid, make sure your password is 6 characters or longer';
                      } else {
                        try {
                          final user =
                              await _fbApp.createUserWithEmailAndPassword(
